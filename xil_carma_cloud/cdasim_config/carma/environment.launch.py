...
def generate_launch_description():
    ...
    vehicle_characteristics_param_file = LaunchConfiguration(
    ...
    declare_vector_map_file = DeclareLaunchArgument(
        name="vector_map_file",
        default_value="vector_map.osm",
        description="Path to the map osm file if using the noupdate load type",
    )
    ...
    object_detection_tracking_param_file = os.path.join(
        get_package_share_directory("object_detection_tracking"),
        "config/parameters.yaml",
    )

    subsystem_controller_default_param_file = os.path.join(
        get_package_share_directory("subsystem_controllers"),
        "config/environment_perception_controller_config.yaml",
    )

    subsystem_controller_param_file = LaunchConfiguration(
    ...
    cp_multiple_object_tracker_node_file = str(
        PurePath(
            get_package_share_directory("carma_cooperative_perception"),
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                extra_arguments=[
                    ...
                    },  # Flag to allow lifecycle node loading in lifecycle wrapper
                ],
                remappings=[
                    (
                        "input",
                    ...
                    ),  # Disable lifecycle topics since this is a lifecycle wrapper container
                    (
                        "get_state",
                        "disabled_get_state",
                    ),  # Disable lifecycle topics since this is a lifecycle wrapper container
            ...
            ComposableNode(
                ...
                remappings=[("points_in", "points_no_ground")],
    ...
    carma_external_objects_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                remappings=[
                    ...
                    (
                        "geofence",
                        [
                            EnvironmentVariable("CARMA_MSG_NS", default_value=""),
            ...
            ComposableNode(
                ...
                parameters=[
                    object_detection_tracking_param_file,
                    vehicle_config_param_file,
                ],
            ),
            ComposableNode(
            ...
            ComposableNode(
                ...
                parameters=[motion_computation_param_file, vehicle_config_param_file],
            ),
    ...
    subsystem_controller = Node(
        ...
        arguments=[
            "--ros-args",
            "--log-level",
            GetLogLevel("subsystem_controllers", env_log_levels),
        ],
    )
