...
def generate_launch_description():
    ...
    carma_external_objects_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                    ...
                    name='external_object_visualizer_node',
                    extra_arguments=[
                        {'use_intra_process_comms': True}
                    ],
                    remappings=[
                        ("external_objects", "external_objects"),
                        ("external_objects_viz", "external_objects_viz")
                    ],
    ...
    carma_cooperative_perception_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                package='carma_cooperative_perception',
                plugin='carma_cooperative_perception::DetectionListVizNode',
                name='detection_list_visualizer_node',
                extra_arguments=[
                    {'use_intra_process_comms': True}
                ],
                remappings=[
                    ("input/detections_lists", "full_detection_list")
                ]
            ),
        ]
    )
